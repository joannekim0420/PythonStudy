...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, model_dim, num_heads, num_layers, d_ff, max_seq_length, dropout):
        ...
        # same as below
        self.encoder_embedding = Embedding(src_vocab_size, model_dim)
        self.decoder_embedding = Embedding(src_vocab_size, model_dim)
